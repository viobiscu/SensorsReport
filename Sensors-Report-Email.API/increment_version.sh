...
DOCKER_IMAGE="viobiscu/sensors-report-email-api:$VERSION"
DOCKER_LATEST="viobiscu/sensors-report-email-api:latest"
cd ..
docker build -f Sensors-Report-Email.API/Dockerfile -t "$DOCKER_IMAGE" .
docker build -f Sensors-Report-Email.API/Dockerfile -t "$DOCKER_LATEST" .
