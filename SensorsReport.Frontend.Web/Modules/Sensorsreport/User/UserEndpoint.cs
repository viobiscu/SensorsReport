...
namespace SensorsReport.Frontend.SensorsReport.User.Endpoints;
[Route("Services/SensorsReport/User/[action]")]
...
public class UserEndpoint : ServiceEndpoint
{
    ...
    public ListResponse<MyRow> List(IDbConnection connection, ListRequest request, [FromServices] IUserListHandler handler)
    {
