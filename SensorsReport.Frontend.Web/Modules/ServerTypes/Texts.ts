...
namespace texts {
    ...
    export declare namespace Db {
        ...
        namespace Administration {
            ...
            namespace UserExternalLogin {
                export const LoginProvider: string;
                export const ProviderKey: string;
                export const UserExternalLoginId: string;
                export const UserId: string;
        ...
        namespace SensorsReport {
            ...
            namespace SensorHistory {
                ...
                export const ObservedAt: string;
                export const PropertyKey: string;
                export const SensorId: string;
