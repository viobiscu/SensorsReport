...
namespace SensorsReport.Provision.API.Controllers;
    ...
    IOptions<OrionLdConfig> config) : ControllerBase
{
    ...
    public async Task<IActionResult> StartProvisioningAsync(ProvisionRequest request)
    {
        ...
        var sourceBroker = _serviceProvider.GetRequiredService<IOrionLdService>();
        var targetBroker = _serviceProvider.GetRequiredService<IOrionLdService>();
    ...
    private async Task CopyRelatedEntities(IOrionLdService sourceBroker, IOrionLdService targetBroker, string entityId, string targetTenant)
    {
    ...
    private async Task ProcessPropertyRecursively(IOrionLdService sourceBroker, IOrionLdService targetBroker, JsonElement propertyValue, string targetTenant)
    {
    ...
    private async Task ProcessRelationship(IOrionLdService sourceBroker, IOrionLdService targetBroker, JsonElement relationshipValue, string targetTenant)
    {
